            ...
            <div class="row footer-widget-wrapper">
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-widget-box about-us">
                        ...
                        <p class="mb-3">
                            Based in Dubai Investment Park 2, Toretto Recovery provides reliable vehicle towing and
                            roadside assistance with a modern fleet of 6 advanced recovery trucks. Our team ensures
                            safe, fast, and affordable solutions across Dubai.
                ...
                <div class="col-md-6 col-lg-6 col-xl-2">
                    <div class="footer-widget-box list">
                        ...
                        <ul class="footer-list">
                            <li><a href="{{ route('home') }}" id="index"><i class="fas fa-caret-right"></i>Home</a>
                            </li>
                            <li><a href="{{ route('about') }}" id="about"><i class="fas fa-caret-right"></i>About
                                    Us</a></li>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-widget-box download-app">
