...
class PageController extends Controller
{
    ...
    public function bookNow()
    {
        ...
        try {
            ...
            $settings = [];
            Log::error('API Error in bookNow(): ' . $e->getMessage());
        }
        $settings = $settings['general_settings'] ?? [];
    ...
    public function blogs()
    {
        ...
        try {
            ...
            $blogs = [];
            Log::error('API Error in blogs(): ' . $e->getMessage());
        }
    ...
    public function blogsdata($slug)
    {
        ...
        try {
            ...
            $blog = [];
            Log::error('API Error in blogsdata(): ' . $e->getMessage());
        }
